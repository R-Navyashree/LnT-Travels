...
export default function Footer() {
  ...
  return (
    <footer style={{ background: '#020617', borderTop: '1px solid rgba(255,255,255,0.05)' }}>
      <div className="container-max px-4 md:px-6 pt-16 pb-10 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
        ...
        <div>
          ...
          <p className="text-xs leading-relaxed mb-5" style={{ color: '#334155' }}>
        ...
        {/* Quick Links */}
        <div>
          <h4 className="font-heading font-bold text-xs tracking-widest uppercase mb-5" style={{ color: '#FBBF24' }}>Quick Links</h4>
        ...
        {/* Services */}
        <div>
          <h4 className="font-heading font-bold text-xs tracking-widest uppercase mb-5" style={{ color: '#FBBF24' }}>Our Services</h4>
          <ul className="space-y-2.5">
            {serviceLinks.map((s) => (
              <li key={s}>
        ...
        {/* Contact */}
        <div>
          <h4 className="font-heading font-bold text-xs tracking-widest uppercase mb-5" style={{ color: '#FBBF24' }}>Contact</h4>
      ...
      <div style={{ borderTop: '1px solid rgba(255,255,255,0.04)' }}>
        <div className="container-max px-4 md:px-6 py-5 flex flex-col sm:flex-row items-center justify-between gap-3">
          <p className="text-[11px] text-center sm:text-left" style={{ color: '#1E293B' }}>
            {year} LnT Travels. All rights reserved. |{' '}
            <span style={{ color: '#FBBF24' }}>Designed by KBLUES TECHNOLOGIES</span>
          </p>
